<footer class="w-full border-t border-stone-300">
	<div class="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-4 px-6 py-6 sm:flex-row">
		<p class="text-sm text-stone-500">&copy; {new Date().getFullYear()} Gato Goggo LLC. All rights reserved.</p>
		<nav class="flex items-center gap-6">
			<a href="/about/contact" class="text-sm font-medium text-stone-600 hover:text-stone-900">
				Contact
			</a>
